...
<script type="text/javascript" src="${tt.getContextPath()}lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="${tt.getContextPath()}/h-ui/js/H-ui.min.js"></script>
<script type="text/javascript" src="${tt.getContextPath()}/h-ui.admin/js/H-ui.admin.js"></script>
<!--/_footer 作为公共模版分离出去-->
